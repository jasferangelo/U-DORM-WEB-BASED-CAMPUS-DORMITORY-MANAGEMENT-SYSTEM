...
CREATE TABLE `add_property` (
  ...
  CONSTRAINT `add_property_ibfk_1` FOREIGN KEY (`owner_id`) REFERENCES `owner` (`owner_id`)
...
(123,	'Philippines',	'Batangas',	'',	'District 4',	'Batangas City',	'Alangilan',	3,	'',	98604621461,	'Full House Rent',	2000000,	2,	3,	3,	3,	3,	'A beautiful property.',	13.756500,	121.058300,	0,	1),
(124,	'Philippines',	'Batangas',	'',	'District 8',	'Batangas City',	'San Jose',	14,	'',	98034805191,	'Room Rent',	2000000,	15,	5,	2,	2,	7,	'near BSU Alangilan',	13.756500,	121.058300,	0,	1),
...
CREATE TABLE `booking` (
  ...
  CONSTRAINT `booking_ibfk_1` FOREIGN KEY (`property_id`) REFERENCES `add_property` (`property_id`),
  CONSTRAINT `booking_ibfk_2` FOREIGN KEY (`tenant_id`) REFERENCES `tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `chat` (
  ...
  KEY `owner_id` (`owner_id`),
  KEY `tenant_id` (`tenant_id`),
  CONSTRAINT `chat_ibfk_1` FOREIGN KEY (`owner_id`) REFERENCES `owner` (`owner_id`),
  CONSTRAINT `chat_ibfk_2` FOREIGN KEY (`tenant_id`) REFERENCES `tenant` (`tenant_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(4,	'Kieth Aguba',	'kiethaguba@gmail.com',	'827ccb0eea8a706c4c34a16891f84e7b',	'',	'Kumintang Batangas City',	'Drivers Licence',	'owner-photo/logo.png');
...
CREATE TABLE `property_photo` (
  ...
  KEY `property_id` (`property_id`),
  CONSTRAINT `property_photo_ibfk_1` FOREIGN KEY (`property_id`) REFERENCES `add_property` (`property_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
CREATE TABLE `review` (
  ...
  KEY `property_id` (`property_id`),
  CONSTRAINT `review_ibfk_1` FOREIGN KEY (`property_id`) REFERENCES `add_property` (`property_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
