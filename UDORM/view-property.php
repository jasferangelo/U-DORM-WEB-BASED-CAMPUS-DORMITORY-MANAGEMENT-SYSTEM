                  ...
                  <div class="col-sm-6">
                    <table>
                      ...
                      <tr>
                        ...
                        <td>
                          <h4><?php echo $rows['street_brgy']; ?></h4>
                        </td>
                      </tr>
                      <tr>
                        <td>
              ...
              <div class="col-sm-6">
                <table>
                  ...
                  <tr>
                    ...
                    <td>
                    <h4><?php echo $rows['descriptions']; ?></h4>
                  </tr>
                </table>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                if ($booked == 0) { ?>
                  ...
                  <input type="submit" class="btn btn-lg btn-primary" name="book_property" style="width: 100%" value="Rent">
                <?php } else { ?>
