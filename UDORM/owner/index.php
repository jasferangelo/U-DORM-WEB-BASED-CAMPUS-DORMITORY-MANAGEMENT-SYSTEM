...
?>
      ...
      $emailpay = $_SESSION["email"];
      if(isset($_POST['btnpay'])){ // Fetching variables of the form which travels in URL
        $name = $_POST['name'];
        $price = $_POST['price'];
        ...
        if($name !=''||$price !=''){
        //Insert Query of SQL
        $sql3 = "INSERT INTO payment (`name`, `amount`,`mon`,`email`) VALUES('$name','$price','$date','$emailpay')";
        $result3 = mysqli_query($db, $sql3);
        echo '<script>alert("Payment Successfully Added")</script>';
        header('Location: http://phpstack-882936-3061747.cloudwaysapps.com/owner');
...
<body>
  ...
  <div class="container-fluid">
    <ul class="nav nav-pills nav-justified">
      ...
      <li style="background-color: #FAFAF0"><a data-toggle="pill" href="#menu6">Rented Property</a></li>
      <li style="background-color: #FAF0E6"><a data-toggle="pill" href="#menuaddpay">Add Payment</a></li>
      <li style="background-color: #FFFACD"><a data-toggle="pill" href="#menupay">View Payment</a></li>
      <li style="background-color: #FAF0E6"><a data-toggle="pill" href="#menugraph">Income Report</a></li>
    </ul>
    ...
    <div class="tab-content">
      ...
      <div id="menuaddpay" class="tab-pane fade">
                     ...
                     <h1>Add Payment</h1>
                        ...
                        <br>
                            ...
                            <div class=" form-group">
                                ...
                                <input id="price" name="price"  class="form-control" type="number" maxlength="255"></input>
                            </div>
                            <table class="table" id="dynamic_field">
                  <tr>
                    <div class="form-group">
                      <label><b>Proof of Payment/Receipt</b></label>
                      <td><input type="file" name="p_photo[]" placeholder="Photos" class="form-control name_list" required accept="image/*" /></td>
                    </div>
                  </tr>
                </table>
                            <button id="PayButton" name="btnpay" class="btn btn-block btn-success submit-button" type="submit">
...
<!-- ============================================= -->
<div id="menupay" class="tab-pane fade">
        <div class="container">

<div style="display:flex;">
<input type="text" style="width:200px;margin-right:5px;" class="form-control" placeholder="Start"  name="date1" id="search"/>
<button onclick="tableToCSV()" style="margin-top:5px;background:transparent;border:none;" type="button"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="#337ab7" class="bi bi-file-earmark-arrow-down" viewBox="0 0 16 16">
  ...
  <?php 
    ...
    $sql3 = "SELECT * from payment where email='$emails'";
        $result3 = mysqli_query($db, $sql3);
...
$(document).ready(function() {
       $('#myModaln').on('show.bs.modal', function(e) {
       
       var id = $(e.relatedTarget).data('id');
       var name = $(e.relatedTarget).data('name');
       var amt = $(e.relatedTarget).data('amt');


       $(e.currentTarget).find('input[name="id"]').val(id);
       $(e.currentTarget).find('input[name="name"]').val(name);
       $(e.currentTarget).find('input[name="amt"]').val(amt);
...
<?php
        include("../config/config.php");
                     $date = date('F');
         $sql ="SELECT * FROM month where mon='".$date."' ";
         $result = mysqli_query($db,$sql);
         $chart_data="";
         ...
         $date = date('F');
         $sqln =" SELECT SUM(amount) as total FROM payment where mon='".$date."' and email='$emails' ";
   ...
   <div id="menugraph" class="tab-pane fade">
    <div class="container">
           <div style="width:90%;height:60%;text-align:center">
            <h2 class="page-header" >Monthly Payment Reports </h2>
            <div>Product </div>
          ...
          <form method="POST" enctype="multipart/form-data">
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label for="ward_no">Room No:</label>
                  <input type="text" class="form-control" id="ward_no" placeholder="Enter room number" name="ward_no">
                </div>
                <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  <label for="descriptions">Ammenities:</label>
                  <input type="text" class="form-control" id="descriptions" placeholder="Enter Descriptions" name="descriptions">
                </div>
                  ...
                  <tr>
                    ...
                    <form method="POST">
                      <td>
                        ...
                        <a data-toggle="pill" class="btn btn-success" name="edit_property" onclick="<?php $property_id = $rows['property_id'] ?>" href="#menu1">Edit</a>
            ...
            <div class="row">
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="ward_no" placeholder="Enter Ward Number" name="ward_no">
                </div>
                <div class="form-group">
                  <label for="contact_no">Contact No.:</label>
                  <input type="number" class="form-control" id="contact_no" placeholder="Enter Phone Number" name="contact_no">
