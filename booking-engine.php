  ...
  if (isset($_SESSION["email"])) {
    ...
    if (mysqli_num_rows($query) > 0) {
      while ($rows = mysqli_fetch_assoc($query)) {
        ...
        $sql1 = "UPDATE add_property SET booked=TRUE WHERE property_id='$property_id'";
        ...
        if ($query2) {
          ...
          $email = $rows['email'];
          $msg = "BOOK APPROVED! Thankyou Mr/Ms " . $rows['full_name'] . " for booking this Property. Please visit the property location to view it personally.";
          $recipient = $email;
