...
$db = new mysqli('localhost', 'nshrcukyhp', 'wb4UgVV29R', 'nshrcukyhp');
...
function add_property()
{
	...
	global $property_id, $province, $city, $street_brgy, $ward_no, $contact_no, $property_type, $price, $total_rooms, $bedroom, $living_room, $kitchen, $bathroom, $descriptions, $latitude, $path, $p_photo, $property_photo_id, $longitude, $owner_id, $booked, $db;

	$province = validate($_POST['province']);
	$city = validate($_POST['city']);
	$street_brgy = validate($_POST['street_brgy']);
	...
	if (mysqli_num_rows($result1) > 0) {
		while ($rowss = mysqli_fetch_assoc($result1)) {
			...
			$sql = "INSERT INTO add_property (province,city,street_brgy,ward_no,contact_no,property_type,price,total_rooms,bedroom,living_room,kitchen,bathroom,descriptions,latitude,longitude,booked,owner_id) VALUES ('$province','$city','$street_brgy','$ward_no','$contact_no','$property_type','$price','$total_rooms','$bedroom','$living_room','$kitchen','$bathroom','$descriptions','$latitude','$longitude','$booked','$owner_id')";
